 ...
 * @author RAM
 */
public class Delete_sales extends javax.swing.JFrame implements ActionListener{
    ...
    public Delete_sales() {
        ...
        Iterator<String> iterator = db.getInvoiceNo().iterator();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Delete Sales", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Times New Roman", 0, 24))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String inv=jComboBox1.getSelectedItem().toString();
         
        if(Flag==false)
        {
            if(inv.equals("Select"))
            {
                String message1 = "Select Invoice No. First!!";
        ...
        if(Flag==false)
        {
            ...
            try{
                db.dbConn();
                String sql="DELETE FROM sales_details WHERE inv_no='"+inv+"'";
                System.out.println(sql);
                int val=db.statement.executeUpdate(sql);
                if(val!=0)
                {
                    String message1 = "Sales Entry DELETED Successfully.....";
                    JOptionPane.showMessageDialog(new JFrame(), message1,
                ...
                {
                    String message1 = "Unable to DELETE Sales Entry.....";
                    JOptionPane.showMessageDialog(new JFrame(), message1,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Delete_sales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Delete_sales().setVisible(true);
            }
        });
    }
