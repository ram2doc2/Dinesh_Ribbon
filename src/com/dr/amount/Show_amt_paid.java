 ...
 * @author RAM
 */
public class Show_amt_paid extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Amount Paid View");
        ...
        jPanel2.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 90, 200, -1));
        ...
        jPanel2.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 90, 200, -1));
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 90, 100, -1));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel2.setText("To Date :");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 90, 100, -1));
        ...
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, -1, -1));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, 700, 370));
        ...
        jPanel2.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 90, 30, -1));
        ...
        jPanel2.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 90, 30, -1));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel4.setText("Designation :");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 40, 100, -1));

        jComboBox1.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select", "All", "Supplier", "Worker", "FixedLabour", "Maintainance", "Finishing", "Packaging", "Stationary", "Machinary", "HouseHold", "HomeLoan", "Loan" }));
        jPanel2.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 40, 200, -1));
    ...
    private void jTextField3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTextField3MouseClicked
        ...
        for(int i=0;i<jTable1.getRowCount();i++)
        {
            ...
            {
                BigDecimal amt=BigDecimal.valueOf(Double.parseDouble(jTable1.getValueAt(i, 2).toString()));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(Flag==false)
        {
            ...
            try{
                ...
                String sql="SELECT date AS 'Date', designation AS 'Designation',total_amt AS 'Total Amount' FROM amt_paid WHERE date BETWEEN '"+f_date+"' AND '"+t_date+"' ";
                ...
                {
                String sql="SELECT date AS 'Date', designation AS 'Designation',total_amt AS 'Total Amount' FROM amt_paid WHERE date BETWEEN '"+f_date+"' AND '"+t_date+"' AND designation='"+Desig+"'";
                System.out.println(sql);
                ResultSet rs=db.statement.executeQuery(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Show_amt_paid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Show_amt_paid().setVisible(true);
            }
        });
    }
