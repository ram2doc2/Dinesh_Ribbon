 ...
 * @author RAM
 */
public class Show_amt_received extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Amount Received View");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Amount Received View", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Times New Roman", 0, 24))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select", "All", "Buyer", "Loan" }));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(Flag==false)
        {
            ...
            try{
                ...
                String sql="SELECT date AS 'Date', designation AS 'Designation',total_amt AS 'Total Amount' FROM amt_received WHERE date BETWEEN '"+f_date+"' AND '"+t_date+"' ";
                ...
                {
                String sql="SELECT date AS 'Date', designation AS 'Designation',total_amt AS 'Total Amount' FROM amt_received WHERE date BETWEEN '"+f_date+"' AND '"+t_date+"' AND designation='"+Desig+"'";
                System.out.println(sql);
                ResultSet rs=db.statement.executeQuery(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Show_amt_received.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Show_amt_received().setVisible(true);
            }
        });
    }
