 ...
 * @author RAM
 */
public class Add_Amount_received extends javax.swing.JFrame implements ActionListener{
    ...
    /**
     * Creates new form Amount_received
     */
    public Add_Amount_received() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Amount Received", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Times New Roman", 0, 24))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select", "Buyer", "Loan" }));
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        if(jComboBox1.getSelectedItem().toString().equals("Buyer"))
        {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Buyer=jComboBox2.getSelectedItem().toString();
        String total_amt=jTextField1.getText();
        String check_no=jTextField2.getText();
        if(Buyer.equals("Select"))
        {
            Buyer="None";
        }
        else
        {
            Buyer=jComboBox2.getSelectedItem().toString();
        }
        if(total_amt.equals(""))
        {
            total_amt="0";
        ...
        if(Flag==false)
        {
            ...
            try {
                ...
                Logger.getLogger(Add_Amount_received.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            try{
                db.dbConn();
                String sql="INSERT INTO amt_received VALUES ('"+Desig+"','"+Buyer+"','"+total_amt+"','"+check_no+"','"+date+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Amount_received.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_Amount_received().setVisible(true);
            }
        });
    }
