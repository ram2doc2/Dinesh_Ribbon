...
public class S16MaximumMatch extends PlainDocument {
    ...
    public S16MaximumMatch(final JComboBox comboBox,String m) {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                switch (e.getKeyCode()) {
                    ...
                    case KeyEvent.VK_DELETE : e.consume();
                                              ...
                                              break;
                    case KeyEvent.VK_F2 :   e.consume();
//                                            if(mo.equals("newCustomer"))
//                                            {
//                                                Customer cs=new Customer("f2Customer");
//                                                cs.setVisible(true);
//                                            }
//                                            else if(mo.equals("newItems"))
//                                            {
//                                                ITEMS it= new ITEMS("f2Items");
//                                                it.setVisible(true);
//                                            }
//                                            else if(mo.equals("newCompany"))
//                                            {
//                                               Company co=new Company("f2Company");
//                                               co.setVisible(true);
//                                            }
//                                            else if(mo.equals("newUnit"))
//                                            {
//                                                Unit un=new Unit("f2Unit");
//                                                un.setVisible(true);
//                                            }
